...
namespace eureka_blocks {
  ...
  //% color="#009A00"  weight=75 blockId=eureka_denkiwhite block="LED |%mode|" group="3_電気の利用ユニット"
  ...
  //% color="#525252" weight=58 blockId=eureka_relay block="ﾘﾚｰ(ﾃﾞｼﾞﾀﾙ出力) |%mode|" group="4_ユーレカ装置"
  ...
  //% color="#525252" weight=56 blockId=eureka_relay_2 block="ﾘﾚｰ(ｱﾅﾛｸﾞ出力) |%limit| |%syuturyoku|" group="4_ユーレカ装置"
